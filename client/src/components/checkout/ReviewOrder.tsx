...
const ReviewOrder = ({ shippingData, cartItems }: ReviewOrderProps) => {
  ...
  const totalPrice = shippingData.deliveryPrice &&  Number((itemsPrice + shippingData.deliveryPrice).toFixed(2));
  ...
  const getWilayaName = (wilayaId: string | number) => {
    ...
    return i18n.language && i18n.language.startsWith("ar")
      ? wilaya.ar_name
      : wilaya.name;
  };
        ...
        <Grid item xs={12} md={6}>
          <Paper className="p-4 shadow-sm rounded-none">
            ...
            <Typography gutterBottom>
              {getWilayaName(shippingData.wilaya)},{" "}
              {getDairaNameFromJson(shippingData.daira)}
            </Typography>
            <Typography gutterBottom>
              {t("checkout.deliveryType")}:{" "}
              {shippingData.deliveryType === "home"
          ...
          <Paper className="p-4 shadow-sm rounded-none">
            ...
            <List disablePadding>
              ...
              <ListItem className="py-2">
                ...
                <Typography variant="body1">
                  DA {shippingData.deliveryPrice && shippingData.deliveryPrice.toFixed(2)}
                </Typography>
              </ListItem>
              ...
              <ListItem className="py-2">
                ...
                <Typography variant="h6" className="font-semibold">
                  DA {totalPrice && totalPrice.toFixed(2)}
                </Typography>
              </ListItem>
            </List>
          </Paper>
